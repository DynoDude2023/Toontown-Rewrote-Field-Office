...
from toontown.battle import DistributedBattleFieldOfficeAI
from BattleCalculatorAI import *
from otp.otpbase import PythonUtil
from toontown.toonbase.ToontownBattleGlobals import *


class DistributedBattleBldgAI(DistributedBattleFieldOfficeAI.DistributedBattleFieldOfficeAI):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBattleBldgAI')

    def __init__(self, air, zoneId, roundCallback=None, finishCallback=None, maxSuits=4, bossBattle=0, isBoiler=False):
        DistributedBattleFieldOfficeAI.DistributedBattleFieldOfficeAI.__init__(self, air, zoneId, finishCallback, maxSuits,
                                                                 bossBattle, isBoiler=isBoiler)
        self.streetBattle = 0
    ...
    def delete(self):
        ...
        DistributedBattleFieldOfficeAI.DistributedBattleFieldOfficeAI.delete(self)
    ...
    def enterResume(self):
        DistributedBattleFieldOfficeAI.DistributedBattleFieldOfficeAI.enterResume(self)
        self.finishCallback(self.zoneId, self.activeToons)

    def exitResume(self):
        DistributedBattleFieldOfficeAI.DistributedBattleFieldOfficeAI.exitResume(self)
