...
import DistributedBattleBaseBoilerAI
from BattleCalculatorAI import *
from otp.otpbase import PythonUtil
from toontown.toonbase.ToontownBattleGlobals import *


class DistributedBattleBoilerAI(DistributedBattleBaseBoilerAI.DistributedBattleBaseBoilerAI):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBattleBldgAI')

    def __init__(self, air, zoneId, roundCallback=None, finishCallback=None, maxSuits=4, bossBattle=0, isBoiler=True):
        DistributedBattleBaseBoilerAI.DistributedBattleBaseBoilerAI.__init__(self, air, zoneId, finishCallback, maxSuits,
    ...
    def delete(self):
        ...
        DistributedBattleBaseBoilerAI.DistributedBattleBaseBoilerAI.delete(self)
    ...
    def enterResume(self):
        DistributedBattleBaseBoilerAI.DistributedBattleBaseBoilerAI.enterResume(self)
        self.finishCallback(self.zoneId, self.activeToons)

    def exitResume(self):
        DistributedBattleBaseBoilerAI.DistributedBattleBaseBoilerAI.exitResume(self)
