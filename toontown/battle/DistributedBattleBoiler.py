...
import DistributedBattleBaseBoiler
...
class DistributedBattleBoiler(DistributedBattleBaseBoiler.DistributedBattleBaseBoiler):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBattleBldg')
    camFOFov = 30.0
    camFOPos = Point3(0, -10, 4)

    def __init__(self, cr, isBoiler=True):
        townBattle = cr.playGame.getPlace().townBattle
        DistributedBattleBaseBoiler.DistributedBattleBaseBoiler.__init__(self, cr, townBattle, isBoiler=isBoiler)
        self.streetBattle = 0
    ...
    def generate(self):
        DistributedBattleBaseBoiler.DistributedBattleBaseBoiler.generate(self)
    ...
    def disable(self):
        DistributedBattleBaseBoiler.DistributedBattleBaseBoiler.disable(self)
        self.battleMusic.stop()

    def delete(self):
        DistributedBattleBaseBoiler.DistributedBattleBaseBoiler.delete(self)
