...
class CSHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        resistancePipe = DistributedResistanceHideoutPipeAI.DistributedResistanceHideoutPipeAI(self.air)
        resistancePipe.generateWithRequired(ToontownGlobals.SellbotHQ)
