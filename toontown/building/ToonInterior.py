...
class ToonInterior(Place.Place):
    ...
    def enter(self, requestStatus):
        ...
        print(self.zoneId)
        if self.zoneId == 22513:
            #toonHallMusic
            base.playMusic(self.loader.toonHallMusic, looping=1, volume=volume)
        elif self.zoneId == 5838:
            #hideOutMusic
            base.playMusic(self.loader.hideOutMusic, looping=1, volume=volume)
        else:
