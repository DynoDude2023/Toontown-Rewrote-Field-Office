...
import DistributedToonInteriorAI, DistributedResistanceHideoutInteriorAI, DistributedToonHallInteriorAI, DistributedSuitInteriorAI, DistributedDoorAI, DoorTypes, DistributedElevatorExtAI, DistributedKnockKnockDoorAI, SuitPlannerInteriorAI, SuitBuildingGlobals, FADoorCodes
...
class DistributedBuildingAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def enterToon(self):
        ...
        elif ZoneUtil.getCanonicalZoneId(interiorZoneId) == 5838:
            self.interior = DistributedResistanceHideoutInteriorAI.DistributedResistanceHideoutInteriorAI(self.block, self.air, interiorZoneId, self)
        else:
