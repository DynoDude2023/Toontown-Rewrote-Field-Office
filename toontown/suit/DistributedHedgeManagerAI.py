...
class DistributedHedgeManagerAI(DistributedSuitBaseAI):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedHedgeManagerAI')
    ...
    def requestBattle(self, x, y, z, h, p, r):
        ...
        battle = DistributedBattleTutorialAI(self.air, TutorialBattleManager(avId), LPoint3f(x, y, z), self, avId,
                                             11000, maxSuits=1, tutorialFlag=0)
