...
class DistributedHardmodeBossbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def __init__(self, air):
        ...
        FSM.FSM.__init__(self, 'DistributedHardmodeBossbotBossAI')
    ...
    def generateSuits(self, battleNumber):
        if battleNumber == 1:
            ...
            retval = self.invokeSuitPlanner(17, 0, customDept='x')
            return retval
        else:
            suits = self.generateDinerSuits()
            return suits

    def invokeSuitPlanner(self, buildingCode, skelecog, customDept='x'):
        suits = DistributedBossCogAI.DistributedBossCogAI.invokeSuitPlanner(self, buildingCode, skelecog, customDept)
