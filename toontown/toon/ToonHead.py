...
EyelashDict = {'d': '/models/char/dog-lashes',
 ...
 'k': '/models/char/crocodile-lashes'}
...
class ToonHead(Actor.Actor):
    ...
    def generateToonColor(self, style):
        ...
        if animalType == 'cat' or animalType == 'crocodile' or animalType == 'rabbit' or animalType == 'bear' or animalType == 'mouse' or animalType == 'pig':
